...
Ou melhor: Use o Live Server do VS Code para rodar com live reload.
...
Cadastre-se na sua aplicação local com o e-mail: admin@levitlon.com

Ao fazer o login com essa conta, o botão "Painel do Admin" será desbloqueado no menu de navegação.

Feito com ☕ e código por Carlos Miranda
